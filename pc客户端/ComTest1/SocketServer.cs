...
namespace SerialportSample
{
    ...
    {
        static Socket acceptSocket;//连接套接字
        static Thread th;//通信线程
        ...
        public static void Listen(int port)
        {
            ...
            while (true)
            {
                acceptSocket = listenSocket.Accept();               //接收挂起的请求，返回一个连接套接字
        ...
        public static void handle()
        {
            ...
            while (true)
            {
                ...
                {
                    //有发送数据请求
                    acceptSocket.Send(encode.GetBytes(s));
                }
            }
            DestroySocket(acceptSocket); //import
        }

        public static void conn(int control)
        {
